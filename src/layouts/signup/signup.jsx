                        ...
                        <div className="card">
                            <div className="card-content">
                                ...
                                <div>
                                    <p>
                                        <label>
                                            <input className="with-gap" name="userGender" type="radio" value="male" defaultChecked/>
                                            <span>Male</span>
                                        </label>
                                        <label className="someright">
                                            <input className="with-gap" name="userGender" type="radio" value="female"/>
                                            <span>Female</span>
                                        </label>
                                    </p>
                                </div>
                        ...
                        <div className="card">
                            <div className="card-content">
                                ...
                                <div>
                                    <p>
                                        <label>
                                            <input className="with-gap" name="findGender" type="radio" value="male" defaultChecked/>
                                            <span>Male</span>
                                        </label>
                                        <label className="someright">
                                            <input className="with-gap" name="findGender" type="radio" value="female"/>
                                            <span>Female</span>
                                        </label>
                                    </p>
                                </div>
                                <div className="input-field">
                                    <input id="minAge" type="number" name="minAge"/>
                                    <label htmlFor="minAge">Min age</label>
                                </div>
                                <div className="input-field">
                                    <input id="maxAge" type="number" name="maxAge"/>
                                    <label htmlFor="maxAge">Max age</label>
                                </div>
                                <div className="input-field">
                                    <input id="maxDistance" type="number" name="maxDistance"/>
